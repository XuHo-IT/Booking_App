            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="indexadmin.jsp" class="nav-item nav-link">Home</a>
                        <a href="roomadmin.jsp" class="nav-item nav-link active">Rooms</a>
                    </div>
...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            %>
           <a href ="addroom.jsp" type="submit" class="btn btn-sm btn-color p-sm-2 px-3" style="border-radius: 30px">Add room</a>
        </div>
    </div>
</div>             
